...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/main': (context) => const MyLandingPage(),
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  labelText: 'Username',
                  labelStyle:
                      TextStyle(color: Color.fromRGBO(165, 165, 165, 0.773)),
                  floatingLabelStyle: TextStyle(
                      color: Color.fromARGB(255, 123, 199, 250), fontSize: 16),
                  filled: true,
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  Image.asset('lib/images/apple.png', height: 30),
                ],
              ),
